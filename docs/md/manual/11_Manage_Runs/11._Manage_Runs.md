...
For the `Active Runs` the system allows user to view high-level metrics information. 
For the runs which CPU/Memory consumption level is lower than a certain level specified in the system configuratins the system displayes **IDLE** label.  
To specify those configurations:  
- Open _Settings_ dashboard and go to the _Preferences_ tab.  
- Go to the _System_ configurations panel:  
    ![CP_ManageRuns](attachments/ManageRuns_38.png)
- Set the following configs:  
    ![CP_ManageRuns](attachments/ManageRuns_39.png)   
...
- Scroll down and press "Save" button at the bottom of the window:  
    ![CP_ManageRuns](attachments/ManageRuns_40.png)  
- Press "Ok" button to proceed:  
    ![CP_ManageRuns](attachments/ManageRuns_41.png)  

The **IDLE** label will be displayed for the run according to the settings in 3 places:  
- At the list of the active runs next to the Run:  
    ![CP_ManageRuns](attachments/ManageRuns_42.png)  
- At the runs information page:  
    ![CP_ManageRuns](attachments/ManageRuns_43.png)  
- At the Home page:  
    ![CP_ManageRuns](attachments/ManageRuns_49.png)  

For the runs which CPU/Memory/Disk consumption is higher than a certain level specified in the system configuratins the system displayes **PRESSURE** label.  
To specify those configurations:  
- Open _Settings_ dashboard and go to the _Preferences_ tab.  
- Go to the _System_ configurations panel:  
    ![CP_ManageRuns](attachments/ManageRuns_38.png)  
...
The **PRESSURE** label will be displayed for the run according to the settings in 2 places:  
- At the list of the active runs next to the Run:  
